...
export const CAREERS: Career[] = [
  ...
  { id: "graphic-designer", title: { en: "Graphic Designer", sw: "Msanifu Picha" }, category: "Arts & Design", description: { en: "Creates visual concepts to communicate ideas that inspire and inform.", sw: "Hubuni picha na michoro kuwasilisha ujumbe." }, activities: [], industries: [], technicalSkills: [], transferableSkills: [], relatedCareers: [], source: { title: "Creative Industry", url: "#" }, lastVerified: "2026-07-23" },
  { id: "hr-manager", title: { en: "HR Manager", sw: "Meneja Rasilimali Watu" }, category: "Business", description: { en: "Plans and directs the administrative functions of an organization.", sw: "Hupanga na kuongoza shughuli za kiutawala za shirika." }, activities: [], industries: [], technicalSkills: [], transferableSkills: [], relatedCareers: [], source: { title: "HR Society of Tanzania", url: "#" }, lastVerified: "2026-07-23" },
  { id: "social-worker", title: { en: "Social Worker", sw: "Mhudumu wa Ustawi wa Jamii" }, category: "Social Sciences", description: { en: "Helps people solve and cope with problems in their everyday lives.", sw: "Husaidia watu kutatua na kukabiliana na matatizo ya maisha." }, activities: [], industries: [], technicalSkills: [], transferableSkills: [], relatedCareers: [], source: { title: "Ministry of Social Welfare", url: "#" }, lastVerified: "2026-07-23" },
  { id: "geologist", title: { en: "Geologist", sw: "Mwanajiolojia" }, category: "Science", description: { en: "Studies the materials, processes, products, physical nature, and history of the Earth.", sw: "Husoma na kufanyia utafiti miamba na madini." }, activities: [], industries: [], technicalSkills: [], transferableSkills: [], relatedCareers: ["mining-engineer"], source: { title: "Geological Survey of Tanzania", url: "https://www.gst.go.tz" }, lastVerified: "2026-07-23" },
  { id: "pilot", title: { en: "Commercial Pilot", sw: "Rubani" }, category: "Aviation", description: { en: "Flies airplanes or helicopters.", sw: "Huurusha ndege au helikopta." }, activities: [], industries: [], technicalSkills: [], transferableSkills: [], relatedCareers: [], source: { title: "TCAA", url: "https://www.tcaa.go.tz" }, lastVerified: "2026-07-23" },
  { id: "tour-guide", title: { en: "Tour Guide", sw: "Mwongoza Watalii" }, category: "Tourism", description: { en: "Guides visitors through attractions like national parks and historical sites.", sw: "Huwaongoza wageni katika mbuga na maeneo ya kihistoria." }, activities: [], industries: [], technicalSkills: [], transferableSkills: [], relatedCareers: [], source: { title: "Tanzania Tourist Board", url: "https://www.tanzaniatourism.go.tz" }, lastVerified: "2026-07-23" },
  { id: "clinical-officer", title: { en: "Clinical Officer", sw: "Afisa Tabibu" }, category: "Health", description: { en: "Examines patients, orders diagnostic tests, and prescribes treatments.", sw: "Huchunguza wagonjwa na kutoa matibabu katika ngazi ya msingi." }, activities: [], industries: [], technicalSkills: [], transferableSkills: [], relatedCareers: ["medical-doctor"], source: { title: "Ministry of Health", url: "https://www.moh.go.tz" }, lastVerified: "2026-07-23" },
  { id: "cybersecurity-analyst", title: { en: "Cybersecurity Analyst", sw: "Mchambuzi wa Usalama wa Mtandao" }, category: "ICT", description: { en: "Protects computer networks and systems.", sw: "Hulinda mitandao na mifumo ya kompyuta dhidi ya udukuzi." }, activities: [], industries: [], technicalSkills: [], transferableSkills: [], relatedCareers: ["software-engineer"], source: { title: "TCRA", url: "https://www.tcra.go.tz" }, lastVerified: "2026-07-23" },
  { id: "quantity-surveyor", title: { en: "Quantity Surveyor", sw: "Mkadiriaji Majenzi" }, category: "Engineering", description: { en: "Manages the costs relating to building and civil engineering projects.", sw: "Husimamia gharama zinazohusiana na miradi ya ujenzi." }, activities: [], industries: [], technicalSkills: [], transferableSkills: [], relatedCareers: ["civil-engineer"], source: { title: "AQRB", url: "https://www.aqrb.go.tz" }, lastVerified: "2026-07-23" },
  { id: "actuary", title: { en: "Actuary", sw: "Mtaalamu wa Bima na Hatari" }, category: "Business", description: { en: "Analyzes the financial costs of risk and uncertainty.", sw: "Huchambua gharama za kifedha za majanga na hatari." }, activities: [], industries: [], technicalSkills: [], transferableSkills: [], relatedCareers: ["accountant"], source: { title: "TIRA", url: "https://www.tira.go.tz" }, lastVerified: "2026-07-23" },
  { id: "logistics-officer", title: { en: "Logistics Officer", sw: "Afisa Usafirishaji na Ugavi" }, category: "Business", description: { en: "Manages the supply chain and transportation of goods.", sw: "Husimamia usafirishaji na mnyororo wa ugavi wa bidhaa." }, activities: [], industries: [], technicalSkills: [], transferableSkills: [], relatedCareers: ["procurement-officer"], source: { title: "NIT", url: "https://www.nit.ac.tz" }, lastVerified: "2026-07-23" },
  { id: "mining-engineer", title: { en: "Mining Engineer", sw: "Mhandisi wa Migodi" }, category: "Engineering", description: { en: "Designs safe and efficient mines for extracting coal and metals.", sw: "Hubuni migodi salama na yenye ufanisi kwa uziduaji wa madini." }, activities: [], industries: [], technicalSkills: [], transferableSkills: [], relatedCareers: ["geologist"], source: { title: "Ministry of Minerals", url: "https://www.madini.go.tz" }, lastVerified: "2026-07-23" },
  { id: "agri-economist", title: { en: "Agricultural Economist", sw: "Mchumi wa Kilimo" }, category: "Agriculture", description: { en: "Applies economic theories to optimize agricultural production.", sw: "Hutumia nadharia za kiuchumi kuboresha uzalishaji wa kilimo." }, activities: [], industries: [], technicalSkills: [], transferableSkills: [], relatedCareers: ["agronomist"], source: { title: "Ministry of Agriculture", url: "https://www.kilimo.go.tz" }, lastVerified: "2026-07-23" },
  { id: "real-estate", title: { en: "Real Estate Valuer", sw: "Mthamini wa Majengo" }, category: "Business", description: { en: "Assesses the value of land and properties.", sw: "Hutathmini thamani ya ardhi na majengo." }, activities: [], industries: [], technicalSkills: [], transferableSkills: [], relatedCareers: ["architect"], source: { title: "Ministry of Lands", url: "https://www.lands.go.tz" }, lastVerified: "2026-07-23" },
];
